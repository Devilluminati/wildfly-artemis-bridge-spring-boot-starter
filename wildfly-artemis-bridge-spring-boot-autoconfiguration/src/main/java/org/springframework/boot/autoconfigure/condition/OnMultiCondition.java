...
public class OnMultiCondition extends FilteringSpringBootCondition implements ConfigurationCondition {
			...
			if (autoConfigurationClass != null) {
				...
				if (outcomes[i] == null) {
					Set<String> onSingleCandidateTypes = autoConfigurationMetadata.getSet(autoConfigurationClass,
							"ConditionalOnMultiCandidate");
					outcomes[i] = getOutcome(onSingleCandidateTypes, ConditionalOnMultiCandidate.class);
				}
			}
		}
		return outcomes;
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
		...
		if (metadata.isAnnotated(ConditionalOnMultiCandidate.class.getName())) {
